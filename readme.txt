IsItChaos est un ensemble de fonctions pour l'exploration des systèmes chaotiques.
...
Certaines fonctions sont utilisables directement sous Scilab ou ScicosLab, et d'autres nécessitent la pré-installation de logiciels additionels. Les étapes suivantes sont nécessaires pour la pleine exploitation de la boite à outils :
    ...
    Télécharger et installer Scilab à partir du site officiel :

    http://www.scilab.org/download/

    Télécharger et installer la bibliothèque TiSeAn en suivant le lien :
    ...
    Télécharger et installer la boite à outils modnum à partir de :
    ...
    Télécharger et installer la bibliothèque WFDB de PhisoBank en suivant le lien :
    ...
    Télécharger les fonctions compressés « IsItChaos » en suivant le lien

    http://sites.google.com/site/isitchaos/telechargement
